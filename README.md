  ...
  ### Just Do IT!
⭐ 휴먼에러를 줄여, 더 뛰어난 가치창출을 위한 환경을 조성하고 로직에 집중하고자 하는 개발자에요. <br>
⭐ 사용자 경험과 개발자 경험(DX) 개선에 관심이 많아요. <br>
⭐ 디자이너 - 개발자 - 현업사이의 Needs 간격을 줄이는 디자인 시스템을 개발하고, <br>
⭐ 찰나의 순간이 감동이 되는, 공간의 제약이 없는 자신만의 미술관을 여는게 꿈이에요. <br>
